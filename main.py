...
# from ldm.modules.diffusionmodules.pixart_utils import set_grad_checkpoint
...
if __name__ == "__main__":
    ...
    try:
        ...
        trainer = Trainer.from_argparse_args(
            trainer_opt, **trainer_kwargs, plugins=DDPPlugin(find_unused_parameters=False)
        )
